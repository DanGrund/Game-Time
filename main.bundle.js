...
/***/ function(module, exports, __webpack_require__) {
	...
	var { Ship, drawLives } = __webpack_require__(1);
	var Asteroid = __webpack_require__(4);
	var { Bullet, drawScore } = __webpack_require__(3);
	...
	function addAsteroid(spawnRate) {
	  if (gameCounter % spawnRate === 0) {
	    var x = Math.random() * 600;
	    var y = Math.random() * 600;
	    if (x < ship.x + ship.width * 2 && x + 50 > ship.x - ship.width && y < y + ship.height * 2 && 50 + y > ship.y - ship.width) {
	      return;
	    } else {
	      var asteroid = new Asteroid(x, y, 50, 50);
	      asteroidArray.push(asteroid);
